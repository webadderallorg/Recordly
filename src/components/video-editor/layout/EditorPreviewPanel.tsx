...
export function EditorPreviewPanel(props: Props) {
	...
	return (
		...
		>
			<div className={isFullscreen ? "flex h-full flex-col" : "flex min-h-0 flex-1 flex-col"}>
				<div className={isFullscreen ? "relative flex h-full flex-col overflow-hidden" : "relative flex min-h-0 flex-1 flex-col overflow-hidden"}>
						{!isFullscreen && (
					...
					<div
						...
						style={{ flex: "1 1 auto", margin: isFullscreen ? "0" : "6px 0 0" }}
					>
					...
					<div className="relative flex flex-shrink-0 items-center px-1 py-1">
						<div className="z-10 flex min-w-0 flex-1 items-center gap-1.5">
							...
							<Button
								...
								variant="ghost"
								size="icon"
								className="h-7 w-7 rounded-full text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary"
