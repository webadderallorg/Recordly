				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-primary/20 text-primary" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
