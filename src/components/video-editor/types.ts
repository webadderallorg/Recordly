...
export const DEFAULT_SCENE_FRAME_STYLE: SceneFrameStyle = "none";
export const DEFAULT_SCENE_FRAME_TEXT = "recordly.app";
export const DEFAULT_SCENE_FRAME_OPACITY = 0.24;
export const DEFAULT_SCENE_FRAME_THICKNESS = 12;
