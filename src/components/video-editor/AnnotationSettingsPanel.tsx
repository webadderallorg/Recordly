...
export function AnnotationSettingsPanel({
	...
	return (
		<div className="flex-[2] min-w-0 bg-editor-panel border border-foreground/10 rounded-lg flex flex-col shadow-xl h-full overflow-hidden">
			<div className="flex-1 min-h-0 p-4 overflow-y-auto custom-scrollbar">
				<div className="mb-6">
					...
					<Tabs
						...
						className="mb-6"
					>
						<TabsList className="mb-4 bg-foreground/5 border border-foreground/5 p-1 w-full grid grid-cols-4 h-auto rounded-lg">
							<TabsTrigger
								value="text"
								...
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<Popover>
											...
											<PopoverContent className="w-[260px] p-3 bg-editor-surface-alt border border-foreground/10 rounded-lg shadow-xl">
												<Block
						...
						<TabsContent value="blur" className="mt-0 space-y-4">
							<div className="p-4 bg-foreground/5 rounded-lg border border-foreground/10 flex flex-col items-center">
