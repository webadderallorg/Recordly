		...
		<Dialog>
			...
			<DialogContent className="max-w-lg bg-editor-dialog border-foreground/10 [&>button]:text-muted-foreground [&>button:hover]:text-foreground">
				...
				<div className="mt-4 space-y-4">
					<div className="rounded-lg border border-foreground/10 bg-foreground/[0.03] p-4 space-y-3">
	...
	return (
		<Dialog>
			...
			<DialogContent className="max-w-lg bg-editor-dialog border-foreground/10 [&>button]:text-muted-foreground [&>button:hover]:text-foreground">
				...
				<div className="mt-4 space-y-4">
					<div className="rounded-lg border border-foreground/10 bg-foreground/[0.03] p-4 space-y-2 text-xs">
