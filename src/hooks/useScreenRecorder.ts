...
export function useScreenRecorder(): UseScreenRecorderReturn {
  ...
  const showRecordingFinalizationToast = useCallback(
  ...
  const startRecording = async (preAcquiredLinuxStream?: MediaStream) => {
    ...
    try {
      ...
      if (wantsAudioCapture) {
        ...
        const useLinuxPortal = selectedSource.id === "screen:linux-portal";
        const mediaStream =
          useLinuxPortal && preAcquiredLinuxStream
            ? preAcquiredLinuxStream
